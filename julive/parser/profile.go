...
var TotalRe = regexp.MustCompile(`参考总价.*</div>[\s\S]+?<div class="td">[\s\S]+?<div class="txt">([^<]*)`)
var PropertyRe = regexp.MustCompile(`<div class="th">楼盘名称</div>[\s\S]+?<div class="td">[\s\S]+?<div class="txt">([^<]*)`)
var AddressRe = regexp.MustCompile(`<div class="th">楼盘地址</div>[\s\S]+?<div class="td">[\s\S]+?<div class="txt">([^<]*)`)
...
var HandRe = regexp.MustCompile(`<div class="th">最早交房</div>[\s\S]+?<div class="td">[\s\S]+?<div class="txt">([^<]*)`)
...
var CompanyRe = regexp.MustCompile(`<div class="th">物业公司</div>[\s\S]+?<div class="td">[\s\S]+?<div class="txt">[\s\S]+?<div class="name" title="([^"]*)`)
var PropertyPriceRe = regexp.MustCompile(`<div class="th">物业费用</div>[\s\S]+?<div class="td">[\s\S]+?<div class="txt">[\s\S]+?<div class="name" title="([^"]*)`)
var WaterGasRe = regexp.MustCompile(`<div class="th">物业费用</div>[\s\S]+?<div class="td">[\s\S]+?<div class="txt">[\s\S]+?<div class="name" title="([^"]*)`)
